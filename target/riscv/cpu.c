...
static void rv64_pz7110_u74_cpu_init(Object *obj)
{
    RISCVCPU *cpu = RISCV_CPU(obj);
    CPURISCVState *env = &cpu->env;
    riscv_cpu_set_misa_ext(env, RVI | RVM | RVA | RVF | RVD | RVC | RVS | RVU);
...
static void rv64_pz7110_s7_cpu_init(Object *obj)
{
    RISCVCPU *cpu = RISCV_CPU(obj);
    CPURISCVState *env = &cpu->env;
...
static const TypeInfo riscv_cpu_type_infos[] = {
    ...
    DEFINE_VENDOR_CPU(TYPE_RISCV_CPU_PZ7110_U74, MXL_RV64,  rv64_pz7110_u74_cpu_init),
    DEFINE_VENDOR_CPU(TYPE_RISCV_CPU_PZ7110_S7,  MXL_RV64,  rv64_pz7110_s7_cpu_init),
